export function ToolPlayer() {
    return (
        <div className="flex w-[41rem] rounded-tool bg-tool shadow-xl shadow-base ring-1 ring-tool">
            <div className="flex items-center space-x-4 px-6 py-4">
                <svg className="size-6 flex-none fill-icon-hint" fill="none">
                ...
                <svg className="size-10 flex-none fill-icon-default" fill="none">
            ...
            <div className="flex flex-auto items-center border-l pl-6 pr-4 text-[0.8125rem]/5 text-subtle">
                <div>00:51</div>
                <div className="ml-4 flex flex-auto rounded-full bg-track">
                    <div className="h-2 w-1/3 flex-none rounded-l-full rounded-r-[1px] bg-active"></div>
                    <div className="-my-[0.3125rem] ml-0.5 h-[1.125rem] w-1 rounded-full bg-active"></div>
                </div>
                <div className="ml-4">55:43</div>
                <svg className="ml-6 size-6 flex-none fill-icon-hint" fill="none">
