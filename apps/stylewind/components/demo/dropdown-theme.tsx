export function DropdownTheme() {
    return (
        <div className="pointer-events-auto_ w-36 space-y-1 rounded-lg bg-surface p-3 text-[0.8125rem]/6 font-medium text-subtle shadow-xl shadow-base ring-1 ring-border">
            <div className="flex rounded-[10px] p-1 bg-slate-50">
                <div className="flex size-6 flex-none items-center justify-center rounded-md bg-surface shadow ring-1 ring-slate-900/10">
                ...
                <div className="ml-3 text-default">Light</div>
            </div>
